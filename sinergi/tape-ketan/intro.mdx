...
| **Admin** | ✅ | ✅ Semua | ✅ Semua | ❌ | ✅ (jika lengkap) |
...
#### Admin
- Full access ke semua agenda
- Dapat edit semua agenda
- **Archive agenda** jika administrasi lengkap
...
- `App\Enums\Agenda\ModaAgenda`
- `App\Enums\Agenda\Pendanaan`
- `App\Enums\Agenda\JenisDokumen`
- `App\Enums\Agenda\KodeTugasAgenda`
- `App\Enums\Agenda\PeranAnggota`

### Services
- `App\Services\AgendaApprovalService`
- `App\Services\AgendaAdministrasiStatusService`
- `App\Services\AgendaApprovalNotificationService`
