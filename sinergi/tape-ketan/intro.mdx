...
```mermaid
graph TD
    A[📝 Pegawai: Buat Usulan Kegiatan] --> B[📄 Upload Desain Kegiatan]
...
└── Review Desain Kegiatan (Tim Perencanaan)

Approval Kepala (/app/approval-kepalas)
└── Review Desain Kegiatan (Kepala)
```
...
### Pengajuan Proposal/Desain Kegiatan
- Minimal 1 anggota panitia (selain creator)
- Upload dokumen desain kegiatan wajib
...
- ✅ Proposal/Desain Kegiatan diajukan
